...
$sqlQuery= "SELECT * from items WHERE ISBN IN (SELECT ISBN as Recommended from itemCF_Recommender where custID = :custid)";
...
if($count>=1){
        if (isset($recommended_items)): ?>
            ...
            <div class="reco_prod_box">
                ...
                <div class="reco_img"><a href="books/details.html.php?ISBN=<?php echo $item['ISBN'];?>"><img src="images/<?php echo $item['thumbNail'];?>" alt="" title="" border="0" width="66" height="100" /></a></div>
